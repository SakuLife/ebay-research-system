...
- accept: 同一商品と確信できる（型番・色・サイズ・タイプ全て一致）
- skip: 別商品の可能性がある、または中古品
- retry: この仕入先は微妙、別を試したい

【重要ルール】
- 商品名の固有名詞（キャラ名、型番等）が違う場合は必ずskip
- 同じブランド・シリーズでも、商品タイプ・色・サイズ・型番が1つでも違えばskip
